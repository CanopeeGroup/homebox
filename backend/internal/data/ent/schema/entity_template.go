...
// EntityTemplate holds the schema definition for the EntityTemplate entity.
type EntityTemplate struct {
	ent.Schema
}

func (EntityTemplate) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixins.BaseMixin{},
		mixins.DetailsMixin{},
		GroupMixin{ref: "entity_templates"},
	}
}

func (EntityTemplate) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("name"),
	}
}

// Fields of the EntityTemplate.
func (EntityTemplate) Fields() []ent.Field {
	return []ent.Field{
...
// Edges of the EntityTemplate.
func (EntityTemplate) Edges() []ent.Edge {
